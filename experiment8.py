...
def main_tree(args):
    ...
    for dataset in datasets:
        ...
        for name in experiments:
            ...
            # experiment for quality of initial cuts for different bounds for fidducia mattheyses algorithm

            args['preprocessing']['nb_cuts'] = 15

            print("\nExperiment 8: Interplay - cut quality and a\n")
            interplay_cut_quality_and_a(args, name)
